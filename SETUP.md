...
## Publishing the repo to a remote

This is a local git repo with no remote yet. To continue elsewhere via
GitHub (or any host):
...
The other machine then clones and follows steps 1–5. Because `.env`,
`.venv/`, `projects/`, and music are gitignored, they never leave your
machine — each clone recreates them per this file.
